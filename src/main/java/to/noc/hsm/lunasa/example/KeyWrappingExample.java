...
/*
 *  Ejemplo de cómo utilizar claves de host cifradas con el proveedor criptográfico Luna SA.
 *  Desafortunadamente, este ejemplo también muestra que el dispositivo AWS CloudHSM 
 *  no protege de la extracción, las claves que se desenvolvieron en el HSM.
 *  Un atacante que obtenga acceso tanto a su base de datos (con claves de host cifradas)
 *  como a su host de cliente HSM puede convertir fácil y rápidamente todas las claves de
 *  host cifradas a su forma no cifrada.
 *
 *  Salida de muestra del código siguiente:
 *
...
public class KeyWrappingExample {
	...
	//
	// AES has a block size of 128 bits or 16 bytes. Used easy HEX values so you can
	// plug them
...
// des3Key = null;
	...
	private static SecretKey createNewHsmKek() throws GeneralSecurityException {
		...
		//
		// LunaTokenObject obj =
		// LunaTokenObject.LocateObjectByHandle(kek.GetKeyHandle());
	...
	//
	private static SecretKey unwrapKeyWithKek(SecretKey hsmKey, String keyAlgorithm, byte[] wrappedKeyBytes)
