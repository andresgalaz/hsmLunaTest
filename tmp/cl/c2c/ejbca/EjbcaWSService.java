...
public class EjbcaWSService extends Service {
    ...
    static {
        URL url = EjbcaWSService.class.getResource("ejbcaws_1.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(EjbcaWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "ejbcaws_1.wsdl");
        }       
        WSDL_LOCATION = url;
    }
